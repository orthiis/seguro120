...
// Obtener vendedores y cobradores para los selectores
    ...
    <div class="card">
        ...
        <form method="POST" class="form-grid" id="editarContratoForm">
            ...
            <div class="form-section">
                ...
                <h4 style="margin-top:1.5rem;margin-bottom:1rem;color:var(--gray-700,#374151);">
                    <i class="fas fa-phone-alt"></i> Contacto
                </h4>
                <div class="form-group">
                    <label for="ec_telefono1">Teléfono Principal</label>
                    <input type="text" id="ec_telefono1" name="telefono1" class="form-control"
                           value="<?php echo htmlspecialchars($contrato['telefono1'] ?? ''); ?>"
                           placeholder="809-000-0000" required>
                </div>
                <div class="form-group">
                    <label for="ec_telefono2">Teléfono 2</label>
                    <input type="text" id="ec_telefono2" name="telefono2" class="form-control"
                           value="<?php echo htmlspecialchars($contrato['telefono2'] ?? ''); ?>"
                           placeholder="Opcional">
                </div>
                <div class="form-group">
                    <label for="ec_no_whatsapp">No. WhatsApp</label>
                    <input type="text" id="ec_no_whatsapp" name="no_whatsapp" class="form-control"
                           value="<?php echo htmlspecialchars($contrato['no_whatsapp'] ?? ''); ?>"
                           placeholder="809-000-0000">
                </div>
                <div class="form-group">
                    <label for="ec_direccion">Dirección</label>
                    <textarea id="ec_direccion" name="direccion" class="form-control" rows="2"
                              placeholder="Dirección completa del asegurado" required><?php
                        echo htmlspecialchars($contrato['direccion'] ?? '');
                    ?></textarea>
                </div>
                ...
                <div class="form-group">
                    <label for="ec_vendedor_id">Vendedor</label>
                    <select id="ec_vendedor_id" name="vendedor_id" class="form-control">
                        <option value="">— Sin vendedor —</option>
                        <?php foreach ($vendedores as $vd): ?>
                            <option value="<?php echo $vd['id']; ?>"
                                <?php echo ($contrato['vendedor_id'] == $vd['id']) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    <label for="ec_cobrador_id">Cobrador</label>
                    <select id="ec_cobrador_id" name="cobrador_id" class="form-control">
                        <option value="">— Sin cobrador —</option>
                        <?php foreach ($cobradores as $cb): ?>
                            <option value="<?php echo $cb['id']; ?>"
                                <?php echo ($contrato['cobrador_id'] == $cb['id']) ? 'selected' : ''; ?>>
