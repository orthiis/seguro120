...
if ($filtro_cobrad !== '') {
    $whereContratos .= " AND c.cobrador_id = ?";
...
$sqlMain = "
    SELECT
        ...
        COALESCE(c.telefono1, cl.telefono1) AS cliente_telefono1,
        c.no_whatsapp       AS cliente_no_whatsapp,
...
.search-wrap-h input.filter-input{padding-left:34px;}
    ...
    <form method="GET" action="vigencia.php" id="formFiltrosVigencia">
        <div class="filter-row-fields">
            ...
            <div class="filter-field field-search">
                ...
                <div class="search-wrap-h" style="position:relative;">
                    <i class="fas fa-search search-icon-h"
                       style="position:absolute;left:10px;top:50%;transform:translateY(-50%);
                              color:var(--gray-400);font-size:12px;pointer-events:none;"></i>
                    <input type="text"
                           id="searchInput"
                           name="buscar"
                           class="filter-input"
                ...
                <tr class="<?php echo $rowCls; ?>">
                    ...
                    <td>
                        <div class="tbl-actions">
                            ...
                            $waRaw     = trim($c['cliente_no_whatsapp'] ?? '');
                            $telWa     = $waRaw !== '' ? $waRaw : trim($c['cliente_telefono1'] ?? '');
