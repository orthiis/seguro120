...
if (!empty($facturas_ids)) {
   ...
   $params = array_merge($params, $facturas_ids);
}

$sql = "
   SELECT f.*, c.numero_contrato, c.dia_cobro,
          c.direccion as cliente_direccion, c.telefono1, c.telefono2, c.no_whatsapp,
...
<body>
    <div class="no-print" style="padding: 20px;">
       ...
       <button onclick="window.print()" class="btn btn-primary"><i class="fas fa-print"></i> Imprimir <?php echo count($facturas); ?> factura(s)</button>
            ...
            <div class="invoice-details">
                <div style="display: flex; justify-content: space-between;">
                    <div>
                        ...
                        <span class="status"> - <?php echo ucfirst($factura1['estado']); ?><?php echo $factura1['esta_asignada'] > 0 ? ' - Asignada' : ''; ?></span>
                    </div>
                    <div class="dates">
            ...
            <div class="invoice-details">
                <div style="display: flex; justify-content: space-between;">
                    <div>
                        ...
                        <span class="status"> - <?php echo ucfirst($factura2['estado']); ?><?php echo $factura2['esta_asignada'] > 0 ? ' - Asignada' : ''; ?></span>
                    </div>
                    <div class="dates">
