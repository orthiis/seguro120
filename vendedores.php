...
$vendedores = $conn->query("
    SELECT v.*,
           COUNT(DISTINCT ct.cliente_id) AS total_clientes,
    ...
    FROM vendedores v
    LEFT JOIN contratos ct ON ct.vendedor_id = v.id AND ct.estado = 'activo'
    LEFT JOIN facturas   f  ON f.contrato_id  = ct.id
    GROUP BY v.id
